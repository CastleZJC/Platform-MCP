...
> |------|----------|----------|----------|--------|
> | v20260603090000 | 2026-06-03 09:00:00 | 初始创建 | 基于技术架构文档，建立 UI 设计令牌与组件规范 | castle.zhang |
>
...
双栏布局：左侧 60% 项目视觉区（项目名称、功能亮点）+ 右侧 40% 登录表单（含角色选择下拉框），底部版权说明。
