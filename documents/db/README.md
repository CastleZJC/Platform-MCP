...
├── 20260905120000_kb_skeleton.sql             ← migration 010 渲染（V3.0 M6 三期 KB 骨架五表）
├── 20260907000000_notify_param_repair.sql     ← migration 011 渲染（notify param_descriptions 双重编码数据修复）
├── 20260907120000_user_page_size.sql          ← migration 012 渲染（pmcp_user 个人每页条数列 + 存量回填 20，head=012）
